...
const Cards = () => {
  ...
  return (
    ...
    >
      <header className="text-7xl text-[#212121] font-normal border-b border-gray-400 px-9 pb-7">
        <h1 className="mt-13">Featured projects</h1>
      </header>
